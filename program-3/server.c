...
/* This program is the server side to a server-client 8 ball protocol connection.
* The server will send codes between it and the client in oder to answer a
* question as if an 8 ball is answering a question to a user.
*/
int
main(void)
{
...
/*
* This function will handle signals sent from the user to the server.
*/
void
sig_handler(int sig)
{
...
/*
* This fuction will randomly pick a message out of 20 provided messages and return the message
*/
char* 
...
/*
* This function will format and make a packet in the form of a string
*/
char* 
make_packet(char packet_code[2], char packet_length[2], char packet_payload[32]) {
...
/*
* This function will sub-string a given string in order to slice it.
*/
char* 
